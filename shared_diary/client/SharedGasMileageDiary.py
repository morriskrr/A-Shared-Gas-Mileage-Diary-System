...
from shared_diary.client.kafka_lib import *
import threading
import datetime
import uuid
import sys
...
class UI(QMainWindow):
    ...
    def __init__(self, BOOTSTRAP_SERVER, KAFKA_TOPIC, GROUP_ID):
        super().__init__()
        ...
        self.input_form = InputForm(BOOTSTRAP_SERVER, KAFKA_TOPIC)
        self.input_layout.addWidget(self.input_form)

        # Create InputViewer tab
        self.output_layout = QVBoxLayout()
        self.input_viewer = InputViewer(self.consumer, BOOTSTRAP_SERVER, KAFKA_TOPIC, GROUP_ID)
...
class InputForm(QWidget):
    ...
    def __init__(self, BOOTSTRAP_SERVER, KAFKA_TOPIC, parent=None):
